...
export const en = {
  common: {
    ...
    footer: {
      ...
      ingestionApiDocs: 'Ingestion API reference',
      sendingGuide: 'Sending measurements guide',
  ...
  evidence: {
    ...
    fields: {
      ...
      positionNoteHint: 'Free-text description of where the sensor sits within the room (e.g. "wall opposite the window, 1.5 m above floor"). Helps consumers judge how representative the readings are.',
      distanceWindowMHint: 'Distance to the nearest window in metres. Proximity to a window skews temperature, light and draught readings.',
      distanceDoorMHint: 'Distance to the nearest door in metres. Door traffic causes short-term spikes in particulates and CO₂.',
      distanceSourceMHint: 'Distance to the nearest known pollution source in metres (e.g. printer or stove). Nearby sources dominate local concentrations.',
      measurementFrequencySecondsHint: 'Declared reporting interval of the device in seconds. Tells consumers the temporal resolution of the published series.',
      ...
      status: 'Status',
      positionNote: 'Position in the room',
      distanceWindowM: 'Distance to window (m)',
      distanceDoorM: 'Distance to door (m)',
      distanceSourceM: 'Distance to pollution source (m)',
      measurementFrequencySeconds: 'Measurement frequency (s)',
    ...
    sensor: {
      ...
      installationOptionalHint:
        'Optional context about the physical installation — all fields may be left blank and can be supplied or changed later.',
