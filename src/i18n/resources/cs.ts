...
export const cs: Resources = {
  common: {
    ...
    footer: {
      ...
      ingestionApiDocs: 'Reference Ingestion API',
      sendingGuide: 'Průvodce odesíláním měření',
  ...
  evidence: {
    ...
    fields: {
      ...
      positionNoteHint: 'Volný popis umístění senzoru v místnosti (např. „stěna naproti oknu, 1,5 m nad podlahou"). Pomáhá konzumentům posoudit reprezentativnost měření.',
      distanceWindowMHint: 'Vzdálenost k nejbližšímu oknu v metrech. Blízkost okna zkresluje měření teploty, světla a průvanu.',
      distanceDoorMHint: 'Vzdálenost k nejbližším dveřím v metrech. Provoz ve dveřích způsobuje krátkodobé špičky prachových částic a CO₂.',
      distanceSourceMHint: 'Vzdálenost k nejbližšímu známému zdroji znečištění v metrech (např. tiskárna nebo sporák). Blízké zdroje dominují lokálním koncentracím.',
      measurementFrequencySecondsHint: 'Deklarovaný interval odesílání měření v sekundách. Říká konzumentům časové rozlišení publikované řady.',
      ...
      status: 'Stav',
      positionNote: 'Umístění v místnosti',
      distanceWindowM: 'Vzdálenost od okna (m)',
      distanceDoorM: 'Vzdálenost od dveří (m)',
      distanceSourceM: 'Vzdálenost od zdroje znečištění (m)',
      measurementFrequencySeconds: 'Frekvence měření (s)',
      installedOn: 'Datum instalace',
      lastCalibratedOn: 'Poslední kalibrace',
    ...
    sensor: {
      ...
      installationTitle: 'Údaje o instalaci',
      installationOptionalHint:
        'Volitelný kontext fyzické instalace — všechna pole lze nechat prázdná a doplnit či změnit později.',
